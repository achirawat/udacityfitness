...
import { getMetricMetaInfo, timeToString, getDailyReminderValue, clearLocationNotification, setLocalNotification } from '../utils/helpers'
...
class AddEntry extends Component {
  ...
  submit = () => {
    ...
    clearLocationNotification().then(setLocalNotification)
  }
  reset = () => {
    const key = timeToString()
