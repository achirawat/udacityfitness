      ...
      {Platform.OS === 'ios' 
        ?
          <View style={{flexDirection: 'row'}}>
            ...
            <TouchableOpacity onPress={onIncrement} style={[styles.iosBtn, {borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderLeftWidth: 0}]}>
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <TouchableOpacity onPress={onIncrement} style={[styles.androidBtn, {borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderLeftWidth: 0}]}>
